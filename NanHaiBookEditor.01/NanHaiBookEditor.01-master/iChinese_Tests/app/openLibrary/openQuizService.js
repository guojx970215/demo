 ...
 /**
  * @ngdoc service
  * @name nanhaiMainApp.openQuizService
  * @description
  * # openQuizService
  * Service in the nanhaiMainApp.
  */
 angular.module('nanhaiMainApp')
   .service('openQuizService', function ($http, apiService, endpoints) {
 
     this.getOpenQuiz = function(bookId){
       var req = {
         method: 'GET',
         url: endpoints.admin + 'libraryaccess/quiz/' + bookId
       };
