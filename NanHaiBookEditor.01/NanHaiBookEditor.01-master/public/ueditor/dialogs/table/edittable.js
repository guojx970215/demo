...
(function() {
  ...
  editTable.prototype = {
    init: function() {
      ...
      domUtils.on(bw, 'change', function() {
        me.setBorderWidth(bw.value);
      });
    ...
    getBorderWidth: function() {
      ...
      borderWidth = cell && domUtils.getComputedStyle(cell, 'border-width');
  ...
  dialog.onok = function() {
    ...
    editor.execCommand('edittablebw', bw.value + "px");
